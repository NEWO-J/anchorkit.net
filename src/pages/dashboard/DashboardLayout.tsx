...
const LIGHT: TC = {
  bg: '#f5f5f5',
  sidebarGrad: 'linear-gradient(180deg, #787878 0%, #717171 100%)',
  sidebarBorder: '1px solid rgba(0,0,0,0.12)',
  sidebarShadow: '1px 0 0 rgba(0,0,0,0.08)',
  strip: '#b0b0b0', stripHover: '#b7b7b7', stripBorder: 'rgba(0,0,0,0.12)',
  caret: 'rgba(0,0,0,0.55)',
  textDim: 'rgba(0,0,0,0.60)', textFaint: 'rgba(0,0,0,0.50)',
  textLabel: 'rgba(0,0,0,0.45)',
  border: 'rgba(0,0,0,0.10)', borderMain: 'rgba(0,0,0,0.12)',
  surface: 'rgba(0,0,0,0.06)', surfaceHover: 'rgba(0,0,0,0.10)',
  overlay: 'rgba(0,0,0,0.28)',
  navInactive: 'rgba(0,0,0,0.50)', navInactiveText: 'rgba(0,0,0,0.60)',
  navActiveText: 'rgba(0,0,0,0.88)', navHoverCls: 'hover:bg-black/[0.07]',
  mobileTitleColor: 'rgba(0,0,0,0.50)', mobileBorder: 'rgba(0,0,0,0.10)',
  searchBg: 'rgba(0,0,0,0.06)', searchBgHover: 'rgba(0,0,0,0.10)',
  searchBorder: 'rgba(0,0,0,0.14)', searchText: 'rgba(0,0,0,0.50)',
  searchIcon: 'rgba(0,0,0,0.50)', searchKbdBg: 'rgba(0,0,0,0.08)',
  searchKbdBorder: 'rgba(0,0,0,0.12)', searchKbdText: 'rgba(0,0,0,0.45)',
  sectionDiv: 'rgba(0,0,0,0.12)', sectionLabel: 'rgba(0,0,0,0.45)',
  collapseBtn: 'rgba(0,0,0,0.45)', collapseBtnHover: 'rgba(0,0,0,0.70)',
  logoutColor: 'rgba(0,0,0,0.60)', themeIcon: 'rgba(0,0,0,0.55)',
};
