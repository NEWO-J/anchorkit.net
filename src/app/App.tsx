...
function FeatureSection({
  ...
  return (
    <section className="w-full border-t border-white/[0.08] bg-[#030028] relative">
      ...
      <div ref={featureInnerRef} className="relative mx-auto border-x border-white/[0.08] bg-[#030028]" style={{ maxWidth: gridMaxW !== undefined ? gridMaxW : '72rem', boxShadow: '-50px 0 60px -10px rgba(3,0,40,0.55), 50px 0 60px -10px rgba(3,0,40,0.55)' }}>
