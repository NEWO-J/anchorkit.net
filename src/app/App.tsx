...
function PrimaryButton({ onClick }: { onClick: () => void }) {
  return (
    ...
    >
      ...
      Github
      <svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M1.5 11.5L11 2"/><path d="M4 2h7v7"/></svg>
    </button>
  );
}
