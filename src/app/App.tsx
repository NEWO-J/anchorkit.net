  ...
  return (
    <div className="flex flex-col w-full">
      <div className="px-8 pt-8 pb-4">
        <h2 className="font-['Inter:Bold',sans-serif] font-bold text-2xl text-white text-center">Latest Anchors</h2>
      </div>
      {/* Header row */}
      ...
      <div className="max-w-[72rem] mx-auto border-x border-white/[0.07]">
        ...
        <div ref={ref2} className="scroll-reveal relative grid lg:grid-cols-2 border-b border-white/[0.07]" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex flex-col justify-center px-16 py-16 order-1 lg:order-2">
            <h2 className="font-['Inter:Bold',sans-serif] font-bold text-2xl text-white mb-8 leading-tight text-center lg:text-left">
        ...
        <div ref={ref4} className="scroll-reveal relative grid lg:grid-cols-2 border-b border-white/[0.07]" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col justify-start px-16 py-16 lg:border-r border-white/[0.07]">
            <h2 className="font-['Inter:Bold',sans-serif] font-bold text-2xl text-white mb-6 leading-tight">
